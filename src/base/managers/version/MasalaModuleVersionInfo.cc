...
MasalaModuleVersionInfo::add_requirement(
    ...
    version_requirements_.insert(
        masala::make_shared< version_requirement::MasalaModuleVersionRequirement >( other_module_name, other_module_not_loaded_message )
    );
}
...
MasalaModuleVersionInfo::add_requirement_with_minimum_version(
    ...
    version_requirements_.insert(
        masala::make_shared< version_requirement::MasalaModuleVersionRequirement >(
            other_module_name,
