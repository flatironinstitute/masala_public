...
/// @file src/base/api/constructor/MasalaObjectAPIConstructorDefinition_NineInput.tmpl.hh
...
/// @details This is a derived class for nine-input constructors.  The types T1, T2, T3, T4, T5, T6, T7, T8, and T9
...
#ifndef Masala_src_base_api_constructor_MasalaObjectAPIConstructorDefinition_NineInput_tmpl_hh
#define Masala_src_base_api_constructor_MasalaObjectAPIConstructorDefinition_NineInput_tmpl_hh

// Base class.
#include <base/api/constructor/MasalaObjectAPIConstructorDefinition.hh>

// Forward declarations.
#include <base/api/constructor/MasalaObjectAPIConstructorDefinition_NineInput.fwd.hh>
...
class MasalaObjectAPIConstructorDefinition_NineInput : public MasalaObjectAPIConstructorDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIConstructorDefinition_NineInput() = delete;
	...
	MasalaObjectAPIConstructorDefinition_NineInput(
	...
	MasalaObjectAPIConstructorDefinition_NineInput( MasalaObjectAPIConstructorDefinition_NineInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIConstructorDefinition_NineInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIConstructorDefinition_NineInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIConstructorDefinition_NineInput";
	}
...
////////////////////////////////////////////////////////////////////////////////
	...
	get_constructor_json_description() const override {
		...
		//Inputs:
		json_api["Constructor_N_Inputs"] = 9;
...
////////////////////////////////////////////////////////////////////////////////
	...
	create_object(
		...
		return masala::make_shared< T0 >( input_parameter_0, input_parameter_1, input_parameter_2, input_parameter_3, input_parameter_4, input_parameter_5, input_parameter_6, input_parameter_7, input_parameter_8 );
	}
...
#endif //Masala_src_base_api_constructor_MasalaObjectAPIConstructorDefinition_NineInput_tmpl_hh