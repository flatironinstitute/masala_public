...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_TwoInput.tmpl.hh
...
#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TwoInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TwoInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_TwoInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_TwoInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_TwoInput() = delete;
	...
	MasalaObjectAPIGetterDefinition_TwoInput(
		...
		std::function< T0( T1, T2 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_TwoInput( MasalaObjectAPIGetterDefinition_TwoInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_TwoInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_TwoInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_TwoInput";
	}
	...
	std::function< T0(T1, T2) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	get_getter_human_readable_description() const override {
    	...
    	ss << "Getter:\t" << (is_virtual_non_override_fxn() ? "virtual " : "" )
			...
			<< "( " << masala::base::api::name_from_type( base::api::type<T1>() ) << ", " << masala::base::api::name_from_type( base::api::type<T2>() ) << " ) const"
	...
	set_function_deprecated () override {
		...
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2 ) >, T1, T2 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2
		);
	}
	...
	set_function_warning () override {
		std::function< T0(T1,T2) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2 ) >, T1, T2 ) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2
		);
	}
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TwoInput_tmpl_hh