...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_FiveInput.tmpl.hh
...
/// @details This is a derived class for five-input getters.  The types T1, T2, T3, T4, and T5
/// define the input type and the type T0 defines the output type.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FiveInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FiveInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_FiveInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_FiveInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_FiveInput() = delete;
	...
	MasalaObjectAPIGetterDefinition_FiveInput(
		...
		std::function< T0( T1, T2, T3, T4, T5 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_FiveInput( MasalaObjectAPIGetterDefinition_FiveInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_FiveInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_FiveInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_FiveInput";
	}
	...
	std::function< T0(T1, T2, T3, T4, T5) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5 ) >, T1, T2, T3, T4, T5 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5) >, T1, T2, T3, T4, T5) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0(T1,T2,T3,T4,T5) > getter_function_;

}; // class MasalaObjectAPIGetterDefinition_FiveInput
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FiveInput_tmpl_hh