...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_FourInput.tmpl.hh
...
#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FourInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FourInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_FourInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_FourInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_FourInput() = delete;
	...
	MasalaObjectAPIGetterDefinition_FourInput(
		...
		std::function< T0( T1, T2, T3, T4 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_FourInput( MasalaObjectAPIGetterDefinition_FourInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_FourInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_FourInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_FourInput";
	}
	...
	function(
		...
		return getter_function_(input1, input2, input3, input4);
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3, T4) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4 ) >, T1, T2, T3, T4 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< void(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4 ) >, T1, T2, T3, T4 ) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0(T1,T2,T3,T4) > getter_function_;
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_FourInput_tmpl_hh