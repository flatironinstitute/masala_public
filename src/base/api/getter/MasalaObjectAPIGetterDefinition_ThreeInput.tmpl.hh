...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_ThreeInput.tmpl.hh
...
/// @details This is a derived class for three-input getters.  The types T1, T2, and T3
/// define the input type and the type T0 defines the output type.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_ThreeInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_ThreeInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_ThreeInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_ThreeInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_ThreeInput() = delete;
	...
	MasalaObjectAPIGetterDefinition_ThreeInput(
		...
		std::function< T0( T1, T2, T3 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_ThreeInput( MasalaObjectAPIGetterDefinition_ThreeInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_ThreeInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_ThreeInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_ThreeInput";
	}
	...
	function(
		...
		return getter_function_(input1, input2, input3);
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		...
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3 ) >, T1, T2, T3 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3
		);
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3 ) >, T1, T2, T3 ) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3
		);
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0(T1,T2,T3) > getter_function_;

}; // class MasalaObjectAPIGetterDefinition_ThreeInput
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_ThreeInput_tmpl_hh