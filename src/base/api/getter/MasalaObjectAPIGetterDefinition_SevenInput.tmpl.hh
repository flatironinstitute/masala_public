...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_SevenInput.tmpl.hh
...
/// @details This is a derived class for seven-input getters.  The types T1, T2, T3, T4, T5, T6, and T7
/// define the input type and the type T0 defines the output type.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_SevenInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_SevenInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_SevenInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_SevenInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_SevenInput() = delete;
	...
	MasalaObjectAPIGetterDefinition_SevenInput(
		...
		std::function< T0( T1, T2, T3, T4, T5, T6, T7 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_SevenInput( MasalaObjectAPIGetterDefinition_SevenInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_SevenInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_SevenInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_SevenInput";
	}
	...
	function(
		...
		return getter_function_(input1, input2, input3, input4, input5, input6, input7);
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3, T4, T5, T6, T7) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7 ) >, T1, T2, T3, T4, T5, T6, T7 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7 ) >, T1, T2, T3, T4, T5, T6, T7 ) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0(T1,T2,T3,T4,T5,T6,T7) > getter_function_;

}; // class MasalaObjectAPIGetterDefinition_SevenInput
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_SevenInput_tmpl_hh