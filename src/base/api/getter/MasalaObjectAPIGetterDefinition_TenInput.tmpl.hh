...
/// @file src/base/api/getter/MasalaObjectAPIGetterDefinition_TenInput.tmpl.hh
...
#ifndef Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TenInput_tmpl_hh
#define Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TenInput_tmpl_hh

// Base class.
#include <base/api/getter/MasalaObjectAPIGetterDefinition.hh>

// Forward declarations.
#include <base/api/getter/MasalaObjectAPIGetterDefinition_TenInput.fwd.hh>
...
class MasalaObjectAPIGetterDefinition_TenInput : public MasalaObjectAPIGetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIGetterDefinition_TenInput() = delete;
	...
	/// @param[in] input_parameter9_description The name of the tenth input parameter.
	...
	MasalaObjectAPIGetterDefinition_TenInput(
		...
		std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) > const & getter_function
	) :
	...
	MasalaObjectAPIGetterDefinition_TenInput( MasalaObjectAPIGetterDefinition_TenInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIGetterDefinition_TenInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIGetterDefinition_TenInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIGetterDefinition_TenInput";
	}
	...
	function(
		...
		return getter_function_(input1, input2, input3, input4, input5, input6, input7, input8, input9, input10);
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) > const * function_raw_ptr() const { return &getter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) >, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) >( &MasalaObjectAPIGetterDefinition::deprecated_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) > const getter_function_copy( getter_function_ );
		getter_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIGetterDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) >, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) >( &MasalaObjectAPIGetterDefinition::warning_function_to_bind ), this, getter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) > getter_function_;
...
#endif //Masala_src_base_api_getter_MasalaObjectAPIGetterDefinition_TenInput_tmpl_hh