...
/// @file src/base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_TwoInput.tmpl.hh
...
#ifndef Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_TwoInput_tmpl_hh
#define Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_TwoInput_tmpl_hh

// Base class.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition.hh>

// Forward declarations.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_TwoInput.fwd.hh>
...
class MasalaObjectAPIWorkFunctionDefinition_TwoInput : public MasalaObjectAPIWorkFunctionDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIWorkFunctionDefinition_TwoInput() = delete;
	...
	MasalaObjectAPIWorkFunctionDefinition_TwoInput(
		...
		std::function< T0( T1, T2 ) > const & work_function
	) :
	...
	MasalaObjectAPIWorkFunctionDefinition_TwoInput( MasalaObjectAPIWorkFunctionDefinition_TwoInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIWorkFunctionDefinition_TwoInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIWorkFunctionDefinition_TwoInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIWorkFunctionDefinition_TwoInput";
	}
	...
	function(
		...
		return work_function_( input1, input2 );
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2) > const * function_raw_ptr() const { return &work_function_; }

	/// @brief Get the number of input parameters.
	/// @details Must be implemented by derived classes.
	/// @returns Override returns 2.
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2 ) >, T1, T2 ) >( &MasalaObjectAPIWorkFunctionDefinition::deprecated_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2
		);
	}
	...
	set_function_warning () override {
		std::function< T0(T1,T2) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2 ) >, T1, T2 ) >( &MasalaObjectAPIWorkFunctionDefinition::warning_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2
		);
	}
...
////////////////////////////////////////////////////////////////////////////////
	...
	get_work_function_json_description() const override {
		...
		//Inputs:
		json_api["Work_Function_N_Inputs"] = 2;
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0( T1, T2 ) > const work_function_;

}; // class MasalaObjectAPIWorkFunctionDefinition_TwoInput
...
#endif //Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_TwoInput_tmpl_hh