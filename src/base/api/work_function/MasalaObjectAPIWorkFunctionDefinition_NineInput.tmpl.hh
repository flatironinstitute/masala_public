...
/// @file src/base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_NineInput.tmpl.hh
...
#ifndef Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_NineInput_tmpl_hh
#define Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_NineInput_tmpl_hh

// Base class.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition.hh>

// Forward declarations.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_NineInput.fwd.hh>
...
class MasalaObjectAPIWorkFunctionDefinition_NineInput : public MasalaObjectAPIWorkFunctionDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIWorkFunctionDefinition_NineInput() = delete;
	...
	MasalaObjectAPIWorkFunctionDefinition_NineInput(
		...
		std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) > const & work_function
	) :
	...
	MasalaObjectAPIWorkFunctionDefinition_NineInput( MasalaObjectAPIWorkFunctionDefinition_NineInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIWorkFunctionDefinition_NineInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIWorkFunctionDefinition_NineInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIWorkFunctionDefinition_NineInput";
	}
	...
	std::function< T0(T1, T2, T3, T4, T5, T6, T7, T8, T9) > const * function_raw_ptr() const { return &work_function_; }

	/// @brief Get the number of input parameters.
	/// @details Must be implemented by derived classes.
	/// @returns Override returns 9.
	masala::base::Size num_input_parameters() const override { return 9; }

	/// @brief Set the function to throw a deprecation error if invoked.
	/// @details Must be implemented by derived classes.
	void
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8,T9) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) >, T1, T2, T3, T4, T5, T6, T7, T8, T9 ) >( &MasalaObjectAPIWorkFunctionDefinition::deprecated_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8,T9) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) >, T1, T2, T3, T4, T5, T6, T7, T8, T9 ) >( &MasalaObjectAPIWorkFunctionDefinition::warning_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	get_work_function_json_description() const override {
		...
		//Inputs:
		json_api["Work_Function_N_Inputs"] = 9;
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) > work_function_;
...
#endif //Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_NineInput_tmpl_hh