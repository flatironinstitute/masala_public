...
/// @file src/base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_SevenInput.tmpl.hh
...
#ifndef Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_SevenInput_tmpl_hh
#define Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_SevenInput_tmpl_hh

// Base class.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition.hh>

// Forward declarations.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_SevenInput.fwd.hh>
...
/// of the API for an object.  Used to auto-generate the public C++ headers,
/// plus the bindings for Python or XML (or other scripting languages).
/// @details This is a derived class for seven-input work functions.  The types T1 through T7
/// define the input types and the type T0 defines the output type.
/// @note A work function can take zero or more inputs, and can return one non-void output.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).
template< typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7 >
class MasalaObjectAPIWorkFunctionDefinition_SevenInput : public MasalaObjectAPIWorkFunctionDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIWorkFunctionDefinition_SevenInput() = delete;
	...
	MasalaObjectAPIWorkFunctionDefinition_SevenInput(
		...
		std::function< T0( T1, T2, T3, T4, T5, T6, T7 ) > const & work_function
	) :
		...
		input_parameter3_name_(input_parameter4_name),
		input_parameter3_description_(input_parameter4_description),
		input_parameter3_name_(input_parameter5_name),
		input_parameter3_description_(input_parameter5_description),
		input_parameter3_name_(input_parameter6_name),
		input_parameter3_description_(input_parameter6_description),
	...
	MasalaObjectAPIWorkFunctionDefinition_SevenInput( MasalaObjectAPIWorkFunctionDefinition_SevenInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIWorkFunctionDefinition_SevenInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIWorkFunctionDefinition_SevenInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIWorkFunctionDefinition_SevenInput";
	}
	...
	function(
		...
		return work_function_( input1, input2, input3, input4, input5, input6, input7 );
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3, T4, T5, T6, T7) > const * function_raw_ptr() const { return &work_function_; }
...
#endif //Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_SevenInput_tmpl_hh