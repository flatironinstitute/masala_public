...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5,T6) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6 ) >, T1, T2, T3, T4, T5, T6 ) >( &MasalaObjectAPIWorkFunctionDefinition::deprecated_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5,T6) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6 ) >, T1, T2, T3, T4, T5, T6 ) >( &MasalaObjectAPIWorkFunctionDefinition::warning_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0( T1, T2, T3, T4, T5, T6 ) > work_function_;
