...
/// @file src/base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_EightInput.tmpl.hh
...
/// @details This is a derived class for four-input work functions.  The types T1 through T8
/// define the input types and the type T0 defines the output type.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_EightInput_tmpl_hh
#define Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_EightInput_tmpl_hh

// Base class.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition.hh>

// Forward declarations.
#include <base/api/work_function/MasalaObjectAPIWorkFunctionDefinition_EightInput.fwd.hh>
...
/// of the API for an object.  Used to auto-generate the public C++ headers,
/// plus the bindings for Python or XML (or other scripting languages).
/// @details This is a derived class for eight-input work functions.  The types T1 through T8
/// define the input types and the type T0 defines the output type.
/// @note A work function can take zero or more inputs, and can return one non-void output.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).
template< typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8 >
class MasalaObjectAPIWorkFunctionDefinition_EightInput : public MasalaObjectAPIWorkFunctionDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPIWorkFunctionDefinition_EightInput() = delete;
	...
	MasalaObjectAPIWorkFunctionDefinition_EightInput(
		...
		std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8 ) > const & work_function
	) :
	...
	MasalaObjectAPIWorkFunctionDefinition_EightInput( MasalaObjectAPIWorkFunctionDefinition_EightInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPIWorkFunctionDefinition_EightInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPIWorkFunctionDefinition_EightInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPIWorkFunctionDefinition_EightInput";
	}
	...
	function(
		...
		return work_function_( input1, input2, input3, input4, input5, input6, input7, input8 );
	}

	/// @brief Get a raw pointer to the function.
	std::function< T0(T1, T2, T3, T4, T5, T6, T7, T8) > const * function_raw_ptr() const { return &work_function_; }

	/// @brief Get the number of input parameters.
	/// @details Must be implemented by derived classes.
	/// @returns Override returns 8.
	masala::base::Size num_input_parameters() const override { return 8; }

	/// @brief Set the function to throw a deprecation error if invoked.
	/// @details Must be implemented by derived classes.
	void
	set_function_deprecated () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8 ) >, T1, T2, T3, T4, T5, T6, T7, T8 ) >( &MasalaObjectAPIWorkFunctionDefinition::deprecated_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< T0(T1,T2,T3,T4,T5,T6,T7,T8) > const work_function_copy( work_function_ );
		work_function_ = std::bind(
			static_cast< T0(MasalaObjectAPIWorkFunctionDefinition::*)(std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8 ) >, T1, T2, T3, T4, T5, T6, T7, T8 ) >( &MasalaObjectAPIWorkFunctionDefinition::warning_function_to_bind ), this, work_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	get_work_function_json_description() const override {
		...
		//Inputs:
		json_api["Work_Function_N_Inputs"] = 8;
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< T0( T1, T2, T3, T4, T5, T6, T7, T8 ) > work_function_;

}; // class MasalaObjectAPIWorkFunctionDefinition_EightInput
...
#endif //Masala_src_base_api_work_function_MasalaObjectAPIWorkFunctionDefinition_EightInput_tmpl_hh