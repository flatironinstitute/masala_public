...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_FiveInput.tmpl.hh
...
/// @details This is a derived class for five-input setters.  The types T1, T2, T3, T4, and T5
/// define the input types.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_FiveInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_FiveInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_FiveInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_FiveInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_FiveInput() = delete;
	...
	MasalaObjectAPISetterDefinition_FiveInput(
		...
		std::function< void( T1, T2, T3, T4, T5 ) > const & setter_function
	) :
	...
	MasalaObjectAPISetterDefinition_FiveInput( MasalaObjectAPISetterDefinition_FiveInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_FiveInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_FiveInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_FiveInput";
	}
	...
	function(
		...
		setter_function_(input1, input2, input3, input4, input5);
	}

	/// @brief Get a raw pointer to the function.
	std::function< void(T1, T2, T3, T4, T5) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			&MasalaObjectAPISetterDefinition::deprecated_function_to_bind<T1, T2, T3, T4, T5>, this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		...
		setter_function_ = std::bind(
			&MasalaObjectAPISetterDefinition::warning_function_to_bind<T1, T2, T3, T4, T5>, this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_FiveInput_tmpl_hh