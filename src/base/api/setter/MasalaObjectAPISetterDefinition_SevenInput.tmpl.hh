...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(T1,T2,T3,T4,T5,T6,T7) >( &MasalaObjectAPISetterDefinition::deprecated_function_to_bind ), this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		...
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(std::function< void(T1, T2, T3, T4, T5, T6, T7) >, T1, T2, T3, T4, T5, T6, T7) >( &MasalaObjectAPISetterDefinition::warning_function_to_bind ), this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
