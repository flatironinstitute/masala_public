...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_ThreeInput.tmpl.hh
...
/// @details This is a derived class for three-input setters.  The types T1, T2, and T3
/// define the input types.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_ThreeInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_ThreeInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_ThreeInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_ThreeInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_ThreeInput() = delete;
	...
	MasalaObjectAPISetterDefinition_ThreeInput(
	...
	MasalaObjectAPISetterDefinition_ThreeInput( MasalaObjectAPISetterDefinition_ThreeInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_ThreeInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_ThreeInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_ThreeInput";
	}
	...
	function(
		...
		setter_function_(input1, input2, input3);
	}

	/// @brief Get a raw pointer to the function.
	std::function< void(T1, T2, T3) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			&MasalaObjectAPISetterDefinition::deprecated_function_to_bind<T1, T2, T3>, this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3
		);
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_ThreeInput_tmpl_hh