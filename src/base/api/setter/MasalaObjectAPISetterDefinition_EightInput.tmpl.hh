...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_EightInput.tmpl.hh
...
#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_EightInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_EightInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_EightInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_EightInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_EightInput() = delete;
	...
	MasalaObjectAPISetterDefinition_EightInput(
		...
		std::function< void( T1, T2, T3, T4, T5, T6, T7, T8 ) > const & setter_function
	) :
	...
	MasalaObjectAPISetterDefinition_EightInput( MasalaObjectAPISetterDefinition_EightInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_EightInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_EightInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_EightInput";
	}
	...
	std::function< void(T1, T2, T3, T4, T5, T6, T7, T8) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(T1,T2,T3,T4,T5,T6,T7,T8) >( &MasalaObjectAPISetterDefinition::deprecated_function_to_bind ), this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< void(T1, T2, T3, T4, T5, T6, T7, T8) > const setter_function_copy( setter_function_ );
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(std::function< void(T1, T2, T3, T4, T5, T6, T7, T8) >, T1, T2, T3, T4, T5, T6, T7, T8) >( &MasalaObjectAPISetterDefinition::warning_function_to_bind ), this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< void(T1,T2,T3,T4,T5,T6,T7,T8) > setter_function_;
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_EightInput_tmpl_hh