...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_SixInput.tmpl.hh
...
#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_SixInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_SixInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_SixInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_SixInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_SixInput() = delete;
	...
	MasalaObjectAPISetterDefinition_SixInput(
		...
		std::function< void( T1, T2, T3, T4, T5, T6 ) > const & setter_function
	) :
	...
	MasalaObjectAPISetterDefinition_SixInput( MasalaObjectAPISetterDefinition_SixInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_SixInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_SixInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_SixInput";
	}
	...
	function(
		...
		setter_function_(input1, input2, input3, input4, input5, input6);
	}

	/// @brief Get a raw pointer to the function.
	std::function< void(T1, T2, T3, T4, T5, T6) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(T1,T2,T3,T4,T5,T6) >( &MasalaObjectAPISetterDefinition::deprecated_function_to_bind ), this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< void(T1, T2, T3, T4, T5, T6) > const setter_function_copy( setter_function_ );
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(std::function< void(T1, T2, T3, T4, T5, T6) >, T1, T2, T3, T4, T5, T6) >( &MasalaObjectAPISetterDefinition::warning_function_to_bind ), this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< void(T1,T2,T3,T4,T5,T6) > setter_function_;

}; // class MasalaObjectAPISetterDefinition_SixInput
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_SixInput_tmpl_hh