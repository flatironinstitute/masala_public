...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_TenInput.tmpl.hh
...
/// @details This is a derived class for ten-input setters.  The types T1, T2, T3, T4, T5, T6, T7, T8, T9, and T10
/// define the input types.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_TenInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_TenInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_TenInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_TenInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_TenInput() = delete;
	...
	/// @param[in] input_parameter7_name The name of the input 8 parameter.
	/// @param[in] input_parameter7_description The description of the input 8 parameter.
	/// @param[in] input_parameter8_name The name of the input 9 parameter.
	/// @param[in] input_parameter8_description The description of the input 9 parameter.
	/// @param[in] input_parameter9_name The name of the input 10 parameter.
	/// @param[in] input_parameter9_description The description of the input 10 parameter.
	...
	MasalaObjectAPISetterDefinition_TenInput(
		...
		std::function< void( T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) > const & setter_function
	) :
	...
	MasalaObjectAPISetterDefinition_TenInput( MasalaObjectAPISetterDefinition_TenInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_TenInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_TenInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_TenInput";
	}
	...
	function(
		...
		setter_function_(input1, input2, input3, input4, input5, input6, input7, input8, input9, input10);
	}

	/// @brief Get a raw pointer to the function.
	std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) >( &MasalaObjectAPISetterDefinition::deprecated_function_to_bind ), this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) > const setter_function_copy( setter_function_ );
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) >, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) >( &MasalaObjectAPISetterDefinition::warning_function_to_bind ), this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< void(T1,T2,T3,T4,T5,T6,T7,T8,T9,T10) > setter_function_;

}; // class MasalaObjectAPISetterDefinition_TenInput
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_TenInput_tmpl_hh