...
/// @file src/base/api/setter/MasalaObjectAPISetterDefinition_NineInput.tmpl.hh
...
/// @details This is a derived class for nine-input setters.  The types T1, T2, T3, T4, T5, T6, T7, T8, and T9
/// define the input types.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_NineInput_tmpl_hh
#define Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_NineInput_tmpl_hh

// Base class.
#include <base/api/setter/MasalaObjectAPISetterDefinition.hh>

// Forward declarations.
#include <base/api/setter/MasalaObjectAPISetterDefinition_NineInput.fwd.hh>
...
class MasalaObjectAPISetterDefinition_NineInput : public MasalaObjectAPISetterDefinition {
...
////////////////////////////////////////////////////////////////////////////////
	...
	MasalaObjectAPISetterDefinition_NineInput() = delete;
	...
	MasalaObjectAPISetterDefinition_NineInput(
		...
		std::function< void( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) > const & setter_function
	) :
	...
	MasalaObjectAPISetterDefinition_NineInput( MasalaObjectAPISetterDefinition_NineInput const & ) = default;

	/// @brief Pure virtual destructor.
	~MasalaObjectAPISetterDefinition_NineInput() override = default;

	/// @brief Every class can name itself.  This returns "MasalaObjectAPISetterDefinition_NineInput".
	std::string
	class_name() const override {
		return "MasalaObjectAPISetterDefinition_NineInput";
	}
	...
	function(
		...
		setter_function_(input1, input2, input3, input4, input5, input6, input7, input8, input9);
	}

	/// @brief Get a raw pointer to the function.
	std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9) > const * function_raw_ptr() const { return &setter_function_; }
...
////////////////////////////////////////////////////////////////////////////////
	...
	set_function_deprecated () override {
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(T1,T2,T3,T4,T5,T6,T7,T8,T9) >( &MasalaObjectAPISetterDefinition::deprecated_function_to_bind ), this,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
	...
	set_function_warning () override {
		std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9) > const setter_function_copy( setter_function_ );
		setter_function_ = std::bind(
			static_cast< void(MasalaObjectAPISetterDefinition::*)(std::function< void(T1, T2, T3, T4, T5, T6, T7, T8, T9) >, T1, T2, T3, T4, T5, T6, T7, T8, T9) >( &MasalaObjectAPISetterDefinition::warning_function_to_bind ), this, setter_function_copy,
			std::placeholders::_1,
			std::placeholders::_2,
			std::placeholders::_3,
			std::placeholders::_4,
...
////////////////////////////////////////////////////////////////////////////////
	...
	std::function< void(T1,T2,T3,T4,T5,T6,T7,T8,T9) > setter_function_;

}; // class MasalaObjectAPISetterDefinition_NineInput
...
#endif //Masala_src_base_api_setter_MasalaObjectAPISetterDefinition_NineInput_tmpl_hh