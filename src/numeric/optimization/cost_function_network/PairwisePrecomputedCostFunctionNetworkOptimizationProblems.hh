...
/// @file src/numeric/optimization/cost_function_network/PairwisePrecomputedCostFunctionNetworkOptimizationProblems.hh
/// @brief Header for a container for PairwisePrecomputedCostFunctionNetworkOptimizationProblems.
...
#ifndef Masala_src_numeric_optimization_cost_function_network_PairwisePrecomputedCostFunctionNetworkOptimizationProblems_hh
#define Masala_src_numeric_optimization_cost_function_network_PairwisePrecomputedCostFunctionNetworkOptimizationProblems_hh

// Forward declarations:
#include <numeric/optimization/cost_function_network/PairwisePrecomputedCostFunctionNetworkOptimizationProblems.fwd.hh>
...
/// @brief A container for PairwisePrecomputedCostFunctionNetworkOptimizationProblems.
/// @details PairwisePrecomputedCostFunctionNetworkOptimizationProblems define a numerical optimization problem to be solved
/// by a suitable Optimizer.  They do not contain any chemistry-specific concepts.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).
class PairwisePrecomputedCostFunctionNetworkOptimizationProblems : public masala::numeric::optimization::cost_function_network::CostFunctionNetworkOptimizationProblems {
...
////////////////////////////////////////////////////////////////////////////////
	...
	PairwisePrecomputedCostFunctionNetworkOptimizationProblems() = default;

	/// @brief Copy constructor.
	/// @details Must be explicitly defined due to mutex.  Copies the pointers to, but does not deep-clone,
	/// the optimization problems.
	PairwisePrecomputedCostFunctionNetworkOptimizationProblems( PairwisePrecomputedCostFunctionNetworkOptimizationProblems const & ) = default;
	...
	operator=(
		PairwisePrecomputedCostFunctionNetworkOptimizationProblems const &
	) = default;

	/// @brief Destructor.
	~PairwisePrecomputedCostFunctionNetworkOptimizationProblems() override = default;
...
#endif // Masala_src_numeric_optimization_cost_function_network_PairwisePrecomputedCostFunctionNetworkOptimizationProblems_hh