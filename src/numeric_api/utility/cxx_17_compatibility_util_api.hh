...
/// @file src/numeric_api/utility/cxx_17_compatibility_util_api.hh
/// @brief Inlined functions with #ifdefs to ensure that functionality that was not implemented for all compilers
/// is available or worked around.  API layer to allow other code to access.
/// @author Vikram K. Mulligan (vmulligan@flatironinstitute.org).

#ifndef Masala_src_numeric_api_utility_cxx_17_compatibility_util_api_hh
#define Masala_src_numeric_api_utility_cxx_17_compatibility_util_api_hh
...
transform_reduce(
	...
	return masala::numeric::utility::transform_reduce( first1, last1, first2, init );
}
...
transform_reduce(
	...
	return masala::numeric::utility::transform_reduce( policy, first1, last1, first2, init );
}
...
transform_reduce(
	...
	return masala::numeric::utility::transform_reduce( first1, last1, first2, init, reduce_operation, transform_operation );
}
...
transform_reduce(
	...
	return masala::numeric::utility::transform_reduce( policy, first1, last1, first2, init, reduce_operation, transform_operation );
}
#endif //MASALA_USE_STL_PARALLEL
...
transform_reduce(
	...
	return masala::numeric::utility::transform_reduce( first, last, init, reduce_operation, transform_operation );
}
...
#endif // Masala_src_numeric_api_utility_cxx_17_compatibility_util_api_hh