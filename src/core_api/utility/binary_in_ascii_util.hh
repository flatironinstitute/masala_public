...
/// @file src/core_api/utility/binary_in_ascii_util.hh
/// @brief Prototypes of API utility functions for storing binary information safely in
...
#ifndef Masala_src_core_api_utility_binary_in_ascii_util_hh
#define Masala_src_core_api_utility_binary_in_ascii_util_hh
