...
/// @file src/core_api/base_classes/chemistry/atoms/coordinates/PluginAtomCoordinateRepresentation.cc
...
#include <core_api/base_classes/chemistry/atoms/coordinates/PluginAtomCoordinateRepresentation.hh>
...
bool
PluginAtomCoordinateRepresentation::protected_empty() const { return true; }
...
void
PluginAtomCoordinateRepresentation::protected_clear() { /*GNDN.*/ }
...
void
PluginAtomCoordinateRepresentation::protected_reset() { /*GNDN.*/ }
...
void
PluginAtomCoordinateRepresentation::protected_make_independent() { /*GNDN.*/ }

/// @brief Assign src to this.  Performs no mutex-locking.
void
PluginAtomCoordinateRepresentation::protected_assign(
    masala::base::managers::engine::MasalaDataRepresentation const & src
) {
    CHECK_OR_THROW_FOR_CLASS( dynamic_cast< PluginAtomCoordinateRepresentation const * >( &src ) != nullptr, "protected_assign",
        "Could not assign an object of type " + src.class_name() + " to an PluginAtomCoordinateRepresentation."
    );
