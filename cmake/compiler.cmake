...
ELSEIF(UNIX)
    ...
    IF( CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 9.5 )
        MESSAGE( "GCC version " ${CMAKE_CXX_COMPILER_VERSION} " detected.  Adding definitions for STL parallel execution poliices." )
        ADD_DEFINITIONS(-DMASALA_USE_STL_PARALLEL)
    else()
        MESSAGE( "GCC version " ${CMAKE_CXX_COMPILER_VERSION} " detected.  Skipping definitions for STL parallel execution poliices." )
    ENDIF()
    IF( ${MODE} STREQUAL "debug" )
	    #ADD_DEFINITIONS(-D_GLIBCXX_DEBUG)
