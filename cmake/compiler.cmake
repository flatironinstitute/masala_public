...
IF( ${MODE} STREQUAL "debug" )
    SET( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O0 -g -ggdb -ffloat-store -D_DEBUG")
    #LIST( APPEND compile -O0 )
    #LIST( APPEND mode -g -ggdb -ffloat-store )
    #LIST( APPEND defines -D_DEBUG )
ELSEIF( ${MODE} STREQUAL "release" )
    SET( CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O3 -ffast-math -fno-finite-math-only -funroll-loops -finline-functions -finline-limit=100000 -s -DNDEBUG")
