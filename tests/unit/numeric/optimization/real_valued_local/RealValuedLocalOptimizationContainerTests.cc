...
TEST_CASE(
    ...
    prob1->add_starting_point( {4, 7, 1} );
    ...
    prob1->add_starting_point( {2, 4, 1} );
    prob1->add_starting_point( {2, 4, 2} );
    ...
    sol1->set_solution_point( Eigen::VectorXd{ 1, 3, 4 } );
    ...
    CHECK( sol1->problem().get() == prob1.get() );
    ...
    sol2->set_solution_point( Eigen::VectorXd{ 5, -2.5, 4.5 } );
    ...
    sol2->set_starting_point_and_index( prob2->starting_points()[1], 0 );
    CHECK( sol2->problem().get() == prob2.get() );
