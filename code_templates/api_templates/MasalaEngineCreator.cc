...
/// defined in plugin libraries, and for the Masala engine and engine
/// system to be able to create engines compatible with particular
/// engines.
...
<__CREATOR_CLASS_API_NAME__>::create_plugin_object() const {
	...
	MASALA_THROW( "<__CREATOR_CLASS_API_NAME__>", "create_plugin_object",
		"The <__SOURCE_CLASS_API_NAME__> engine class is not instantiable."
	);
	return nullptr;
#else
...
////////////////////////////////////////////////////////////////////////////////
// PUBLIC MEMBER FUNCTIONS FOR MaslaEngines
////////////////////////////////////////////////////////////////////////////////
...
std::vector< std::vector< std::string > >
<__CREATOR_CLASS_API_NAME__>::get_engine_categories() const {
	return std::vector< std::vector< std::string > > {
		<__ENGINE_CATEGORIES__>
	};
}
