...
## @brief Auto-generate the forward declaration fole (***Creator.fwd.hh) for the creator for a plugin class.
...
for element in json_api["Elements"] :
    ...
    if is_plugin_class == True :
        ...
        # prepare_creator_cc_file( plugin_creator_ccfile_template, licence_template, creator_name, creator_namespace, creator_filename, json_api, name_string, namespace, library_name, project_name  )
